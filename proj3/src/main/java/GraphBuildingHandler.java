...
public class GraphBuildingHandler extends DefaultHandler {
    ...
    private Map<String,Way> idWay = new HashMap<>();

    private boolean flag = false;//to help write the node of last id when beginning a way

    private Long id;//to help write the node of last id when beginning a way
    private Way way;
    ...
    public void startElement(String uri, String localName, String qName, Attributes attributes)
        ...
        if (qName.equals("node")) {
            ...
            g.graph.put(Long.parseLong(attributes.getValue("id")),new ArrayList<Long>());
            GraphDB.Node node = new GraphDB.Node();
            node.nodeLocation(Double.parseDouble(attributes.getValue("lon")),Double.parseDouble(attributes.getValue("lat")));
            g.idMap.put(Long.parseLong(attributes.getValue("id")),node);
            ...
            way.nodeList.add(attributes.getValue("ref"));
            ...
            if (k.equals("maxspeed")) {
                ...
                way.type = v;
                if(ALLOWED_HIGHWAY_TYPES.contains(way.type))
                way.vaild = true;
